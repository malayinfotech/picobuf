...
//go:generate protoc --pico_out=paths=source_relative:./pico/one --pico_opt=Mmsg-one.proto=picobuf/internal/sizebench/pico/one msg-one.proto
//go:generate protoc --pico_out=paths=source_relative:./pico/two --pico_opt=Mmsg-two.proto=picobuf/internal/sizebench/pico/two msg-two.proto
//go:generate protoc --pico_out=paths=source_relative:./pico/sml --pico_opt=Mmsg-sml.proto=picobuf/internal/sizebench/pico/sml msg-sml.proto
//go:generate protoc --go_out=paths=source_relative:./prot/one --go_opt=Mmsg-one.proto=picobuf/internal/sizebench/prot/one msg-one.proto
//go:generate protoc --go_out=paths=source_relative:./prot/two --go_opt=Mmsg-two.proto=picobuf/internal/sizebench/prot/two msg-two.proto
//go:generate protoc --go_out=paths=source_relative:./prot/sml --go_opt=Mmsg-sml.proto=picobuf/internal/sizebench/prot/sml msg-sml.proto
